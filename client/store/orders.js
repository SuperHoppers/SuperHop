...
export const addToCart = (orderId, productId) => {
  return async (dispatch) => {
    try {
      const { data } = await axios.put('/api/orders/addToCart', {
        orderId: orderId,
        productId: productId,
      });
...
export const increaseQuantity = (orderId, productId) => {
  return async (dispatch) => {
    try {
      const { data } = await axios.put('/api/orders/increaseQuant', {
        orderId: orderId,
        productId: productId,
      });
...
export const removeFromCart = (orderId, productId) => {
  return async (dispatch) => {
    try {
      const { data } = await axios.put('/api/orders/removeFromCart', {
        orderId: orderId,
        productId: productId,
      });
